...
export function Footer() {
    ...
    return (
        <footer className="border-t bg-muted py-2 mt-auto">
            <div className="mx-auto w-[80%] px-4 sm:px-6 md:px-8 lg:px-10 text-center text-sm text-muted-foreground py-2">
